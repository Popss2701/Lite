...
class LeCartCustom(LeBasecart):
	...
	def convert_category_export(self, category, categories_ext):
		...
		category_data['categories_ext'] = categories_ext['data']['categories_description'][0]
	...
	def get_products_ext_export(self, products):
		...
		languages_ids = duplicate_field_value_from_list(product_ext['data']['products_description'], 'languages_id')
	...
	def convert_order_export(self, order, orders_ext):
		...
		customer_address['first_name'] = order['delivery_name']
		customer_address['last_name'] = order['delivery_name']
